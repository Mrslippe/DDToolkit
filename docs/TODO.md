...
| 桌面端图标清晰度（任务栏/资源管理器） | ✅ 已修（2026-09-09，devlog/043：Tauri 取 ICO 目录首项当窗口图标，旧文件首项是 16×16 → 首项改 48px 简化加粗层 + 按尺寸补偿描边；**需重新构建桌面端才生效**） |
...
- ✅ **界面细节六项**（2026-09-09，devlog/043）：任务栏图标清晰度（ICO 首项/按尺寸补偿描边，见上表）、顶栏标题字体统一阿里妈妈方圆体、滚动条「粉只属于指针」+ 指针近右缘亮出、二级弹窗关闭钮改 `focus-visible` 焦点环、单图帖封面与正文图按 URL 去重（查看器不再显示两张）、顶栏状态行改浅粉底外发光玻璃胶囊（26px/13px/深玫色 `#a83a5e`）
