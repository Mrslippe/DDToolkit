...
| 前端单测 | `npm --prefix frontend run test` | **251 passed**（`addVtuberSearch` 7 · `capabilities` 6 · `reservationDays` 9 · `notificationHub` 12 · `idleQuotes` 18 · `settingsDraft` 22 · `settingsNav` 16 · `theme` 13 · `shellState` 11 · `shellLifecycle` 6 · 其余既有） |
