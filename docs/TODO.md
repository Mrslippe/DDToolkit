...
| 弹幕词云 | ✅ 场次级 top40（danmakus v2 live 词云）＋加权 Voronoi 自绘拼贴；**原始弹幕明细库/全量分析暂缓** |
...
- ✅ **弹幕词云**（2026-09-07）：danmakus v2 live 词云 top40 → **加权 Voronoi 拼贴**（power diagram，Balzer 2005，零依赖自绘，面积∝词频，种子确定性布局）
