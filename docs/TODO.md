...
> **R26 已全部落地**（① devlog/126 · ②③④ devlog/128 —— 原文与结论见「需求清单：R26」）、
> **R27 已落地**（devlog/125）、**R28 已落地**（devlog/127）。
> 接下来做 **R29**（风控状态对托盘用户可见）。盘点依据与实测数字见
> `docs/ARCHITECTURE.md` §3.5 与 devlog/124。
