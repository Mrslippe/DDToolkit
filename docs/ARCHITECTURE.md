...
| ⚠️ **已知缺口** | `_PlatformBudget._rpm_for()` 会把平台预算抬到"至少装得下一轮" ⇒ **稳态速率随账号数线性上抬且无衰减**（30 个 B 站账号 ≈ 30 req/min ≈ 4.3 万/天）。收口方案见 `docs/TODO.md` §0 的 **R28**（2026-09-16 盘点时记的两条缺口里，"冷却不落库"已由 **R27** 修掉，见 devlog/125） |
